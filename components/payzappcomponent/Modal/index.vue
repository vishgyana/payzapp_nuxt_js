...
<!--      Open large modal-->
<!--    </button>-->
    <div v-if="showModal" class="p-5 overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center flex" data-aos="zoom"
