import {
  ...
  export default {
    ...
    state: () => ({
      ...
      audiolink: [
        {
          url: "https://audio.lanevservices.in/audio/STE-109_trimmed.mp3",
        },
        {
          url: "https://audio.lanevservices.in/audio/STE-111_trimmed.mp3",
        },
        {
          url: "https://audio.lanevservices.in/audio/STE-113_trimmed.mp3",
        },
        {
          url: "https://audio.lanevservices.in/audio/STE-120_trimmed.mp3",
        },
        {
          url: "https://audio.lanevservices.in/audio/STE-122_trimmed.mp3",
        },
        {
          url: "https://audio.lanevservices.in/audio/STE-122_trimmed.mp3",
        },
